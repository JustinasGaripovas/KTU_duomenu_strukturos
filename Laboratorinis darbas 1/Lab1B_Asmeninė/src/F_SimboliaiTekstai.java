...
// -----------------------------------------------------------------------------
    ...
    void met8(){
        ...
        vardas = vardas.replaceAll("[^a-zA-Z0-9]", "");


        for (String pas: pastas) {
            for (String dom: domain) {
                System.out.println(vardas + pas + dom);
            }
            System.out.println();
        }
...
// -----------------------------------------------------------------------------
    ...
    void met9(){
        ...
        {
            System.out.println(vardas+rand.nextInt(1000)+"@gmail.com");
        }
