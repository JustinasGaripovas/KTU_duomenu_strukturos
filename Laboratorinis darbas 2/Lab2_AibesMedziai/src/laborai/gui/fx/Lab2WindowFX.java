...
public class Lab2WindowFX extends BorderPane implements EventHandler<ActionEvent> {
    ...
    private static SortedSetADTx<Automobilis> bookSet;
    ...
    private void treeGeneration(String filePath) throws MyException {
        ...
        if (filePath == null) {
            ...
            bookSet.load(filePath);
            autoArray = new Automobilis[bookSet.size()];
            int i = 0;
        ...
        KsFX.setFormatStartOfLine(true);
        KsFX.oun(taOutput, bookSet.toVisualizedString(tfDelimiter.getText()),
    ...
    private void treeRemove() {
        ...
        if (bookSet.isEmpty()) {
            ...
            Automobilis auto = (Automobilis) bookSet.toArray()[nr];
            bookSet.remove(auto);
    ...
    private void treeIteration() {
        ...
        if (bookSet.isEmpty()) {
            ...
            KsFX.oun(taOutput, bookSet, MESSAGES.getString("msg8"));
        }
        KsFX.setFormatStartOfLine(false);
    }
    ...
    private void createTree() throws MyException {
        switch (cmbTreeType.getSelectionModel().getSelectedIndex()) {
            case 0:
                bookSet = new BstSetKTUx(new Automobilis());
                break;
            case 1:
                bookSet = new AvlSetKTUx(new Automobilis());
                break;
            default:
                disableButtons(true);
