...
// -----------------------------------------------------------------------------
    /**
     * Demonstravimui reikalinwagiems metodams komentarai yra nuimami.
...
// -----------------------------------------------------------------------------
    ...
    void met6(){
        ...
        for(int[] PS: paintingSpaces){  // ciklas per 2mačio eilutes
            for(int a: PS) {    // ciklas eiluteje
                for (int i=0;i<a;i++) {
                    if (first == true) {
                        System.out.print(paintingParts[0]);
                    } else {
                        System.out.print(paintingParts[1]);
                    }
                }
                first = !first;
